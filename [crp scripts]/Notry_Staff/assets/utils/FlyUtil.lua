...
function flyToggle()
    local state = getElementData(localPlayer, config["ElementDataBase"])
...
addEvent("Notry:flyToggle", true)
addEventHandler("Notry:flyToggle", getRootElement(), flyToggle)
...
function settpway(x, y, z)
    abx, aby, abz = x, y, z or 13
end
addEvent("tpway", true)
addEventHandler("tpway", root, settpway)