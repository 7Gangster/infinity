...
function dxCreateFont (path, scale, ...)
    ...
    return _dxCreateFont (path, math.floor(scale), ...)
end
...
function dxDrawPolygon ( x, y, w, h, color, post )
    ...
    if polygons[w][h] then
        dxDrawImage(x, y, w, h, polygons[w][h], 0, 0, 0, color, post or false)
    end
end
...
font = {
    ['poppins'] = {
        ['regular'] = {
            [10] = dxCreateFont('src/assets/fonts/Poppins-Regular.ttf', 10, false),
            [12] = dxCreateFont('src/assets/fonts/Poppins-Regular.ttf', 12, false),
            [14] = dxCreateFont('src/assets/fonts/Poppins-Regular.ttf', 14, false),
            [16] = dxCreateFont('src/assets/fonts/Poppins-Regular.ttf', 16, false),
            [20] = dxCreateFont('src/assets/fonts/Poppins-Regular.ttf', 20, false),
        },
        ['medium'] = {
            [10] = dxCreateFont('src/assets/fonts/Poppins-Medium.ttf', 10, false),
            [12] = dxCreateFont('src/assets/fonts/Poppins-Medium.ttf', 12, false),
            [14] = dxCreateFont('src/assets/fonts/Poppins-Medium.ttf', 14, false),
            [16] = dxCreateFont('src/assets/fonts/Poppins-Medium.ttf', 16, false),
            [20] = dxCreateFont('src/assets/fonts/Poppins-Medium.ttf', 20, false),
        },
        ['semibold'] = {
            [10] = dxCreateFont('src/assets/fonts/Poppins-SemiBold.ttf', 10, false),
            [12] = dxCreateFont('src/assets/fonts/Poppins-SemiBold.ttf', 12, false),
            [14] = dxCreateFont('src/assets/fonts/Poppins-SemiBold.ttf', 14, false),
            [16] = dxCreateFont('src/assets/fonts/Poppins-SemiBold.ttf', 16, false),
            [20] = dxCreateFont('src/assets/fonts/Poppins-SemiBold.ttf', 20, false),
        },
        ['bold'] = {
            [10] = dxCreateFont('src/assets/fonts/Poppins-Bold.ttf', 10, false),
            [12] = dxCreateFont('src/assets/fonts/Poppins-Bold.ttf', 12, false),
            [14] = dxCreateFont('src/assets/fonts/Poppins-Bold.ttf', 14, false),
            [16] = dxCreateFont('src/assets/fonts/Poppins-Bold.ttf', 16, false),
            [20] = dxCreateFont('src/assets/fonts/Poppins-Bold.ttf', 20, false),
        },
    },
}