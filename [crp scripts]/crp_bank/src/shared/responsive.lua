...
svgsRectangle = {};
function dxDrawRoundedRectangle(x, y, w, h, radius, color, post, relative)
...
font = {
    ...
    ['roboto2'] = {
        ['regular'] = {
            [8] = _dxCreateFont('src/assets/fonts/Roboto-Regular.ttf', 10, false, 'default'),
            [10] = _dxCreateFont('src/assets/fonts/Roboto-Regular.ttf', 10, false, 'default'),
            [12] = _dxCreateFont('src/assets/fonts/Roboto-Regular.ttf', 12, false, 'default'),
            [14] = _dxCreateFont('src/assets/fonts/Roboto-Regular.ttf', 14, false, 'default'),
            [16] = _dxCreateFont('src/assets/fonts/Roboto-Regular.ttf', 16, false, 'default'),
            [20] = _dxCreateFont('src/assets/fonts/Roboto-Regular.ttf', 20, false, 'default'),
            [40] = _dxCreateFont('src/assets/fonts/Roboto-Regular.ttf', 40, false, 'default'),
        },
        ['medium'] = {
            [10] = _dxCreateFont('src/assets/fonts/Roboto-Medium.ttf', 10, false, 'default'),
            [12] = _dxCreateFont('src/assets/fonts/Roboto-Medium.ttf', 12, false, 'default'),
            [14] = _dxCreateFont('src/assets/fonts/Roboto-Medium.ttf', 14, false, 'default'),
            [16] = _dxCreateFont('src/assets/fonts/Roboto-Medium.ttf', 16, false, 'default'),
            [20] = _dxCreateFont('src/assets/fonts/Roboto-Medium.ttf', 20, false, 'default'),
        },
        ['bold'] = {
            [10] = _dxCreateFont('src/assets/fonts/Roboto-Bold.ttf', 10, false, 'default'),
            [12] = _dxCreateFont('src/assets/fonts/Roboto-Bold.ttf', 12, false, 'default'),
            [14] = _dxCreateFont('src/assets/fonts/Roboto-Bold.ttf', 14, false, 'default'),
            [16] = _dxCreateFont('src/assets/fonts/Roboto-Bold.ttf', 16, false, 'default'),
            [20] = _dxCreateFont('src/assets/fonts/Roboto-Bold.ttf', 20, false, 'default'),
        },
    },
}