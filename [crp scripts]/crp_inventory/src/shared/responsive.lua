...
font = {
    ['poppins'] = {
        ['regular'] = {
            [10] = dxCreateFont('src/assets/fonts/Poppins-Regular.ttf', 10),
            [12] = dxCreateFont('src/assets/fonts/Poppins-Regular.ttf', 12),
            [14] = dxCreateFont('src/assets/fonts/Poppins-Regular.ttf', 14),
            [16] = dxCreateFont('src/assets/fonts/Poppins-Regular.ttf', 16),
            [20] = dxCreateFont('src/assets/fonts/Poppins-Regular.ttf', 20),
        },
        ['medium'] = {
            [10] = dxCreateFont('src/assets/fonts/Poppins-Medium.ttf', 10),
            [12] = dxCreateFont('src/assets/fonts/Poppins-Medium.ttf', 12),
            [14] = dxCreateFont('src/assets/fonts/Poppins-Medium.ttf', 14),
            [16] = dxCreateFont('src/assets/fonts/Poppins-Medium.ttf', 16),
            [20] = dxCreateFont('src/assets/fonts/Poppins-Medium.ttf', 20),
        },
        ['semibold'] = {
            [10] = dxCreateFont('src/assets/fonts/Poppins-SemiBold.ttf', 10),
            [12] = dxCreateFont('src/assets/fonts/Poppins-SemiBold.ttf', 12),
            [14] = dxCreateFont('src/assets/fonts/Poppins-SemiBold.ttf', 14),
            [16] = dxCreateFont('src/assets/fonts/Poppins-SemiBold.ttf', 16),
            [20] = dxCreateFont('src/assets/fonts/Poppins-SemiBold.ttf', 20),
        },
        ['bold'] = {
            [10] = dxCreateFont('src/assets/fonts/Poppins-Bold.ttf', 10),
            [12] = dxCreateFont('src/assets/fonts/Poppins-Bold.ttf', 12),
            [14] = dxCreateFont('src/assets/fonts/Poppins-Bold.ttf', 14),
            [16] = dxCreateFont('src/assets/fonts/Poppins-Bold.ttf', 16),
            [20] = dxCreateFont('src/assets/fonts/Poppins-Bold.ttf', 20),
        },
    },
    ['roboto'] = {
        ['regular'] = {
            ...
            [40] = dxCreateFont('src/assets/fonts/Roboto-Regular.ttf', 40),
        },
        ['medium'] = {
